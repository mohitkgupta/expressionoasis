...
public class BWAndExpression extends BinaryOperatorExpression
{
	...
	static
	{
		...
		addTypePair( BWAndExpression.class, Type.OBJECT, Type.OBJECT, Type.LONG );
		addTypePair( BWAndExpression.class, Type.INTEGER, Type.OBJECT, Type.LONG );
		addTypePair( BWAndExpression.class, Type.OBJECT, Type.INTEGER, Type.LONG );
		addTypePair( BWAndExpression.class, Type.LONG, Type.OBJECT, Type.LONG );
		addTypePair( BWAndExpression.class, Type.OBJECT, Type.LONG, Type.LONG );
	}
