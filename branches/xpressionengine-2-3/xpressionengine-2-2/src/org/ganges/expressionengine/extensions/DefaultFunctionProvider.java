	...
	public ValueObject getFunctionValue( String functionName, ValueObject[] parameters )
		...
		if( method != null ) {
			try {
				...
				Object result = method.invoke( functionProviderClass, params );
				value = new ValueObject( result, Type.createType( method.getReturnType() ) );
			}
			catch( Exception ex ) {
				throw new ExpressionEngineException( "Error occured while executing method." );
			}
		}
