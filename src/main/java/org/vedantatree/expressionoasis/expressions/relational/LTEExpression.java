...
public class LTEExpression extends BinaryOperatorExpression {
	...
	static {
		...
		addTypePair( LTEExpression.class, Type.OBJECT, Type.OBJECT, Type.BOOLEAN );
		addTypePair( LTEExpression.class, Type.LONG, Type.OBJECT, Type.BOOLEAN );
		addTypePair( LTEExpression.class, Type.OBJECT, Type.LONG, Type.BOOLEAN );
		addTypePair( LTEExpression.class, Type.DOUBLE, Type.OBJECT, Type.BOOLEAN );
		addTypePair( LTEExpression.class, Type.OBJECT, Type.DOUBLE, Type.BOOLEAN );
	}
