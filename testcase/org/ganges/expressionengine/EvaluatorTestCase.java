...
public class EvaluatorTestCase extends TestCase {
	...
	public static void main( String[] args ) throws ExpressionEngineException {
		TestRunner.run( EvaluatorTestCase.class );
	}
	...
	protected void setUp() throws Exception {
		...
		expressionContext.setContextProperty( ExpressionEngineConstants.EXPRESSION_CONTENXT_XML_PATH_URL, new URL(
				"file:\\F:/temp/test.xml" ) );
	}
